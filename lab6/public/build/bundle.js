...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			input = element("input");
    			add_location(label, file, 198, 2, 5598);
    			attr_dev(input, "id", "slider");
    			attr_dev(input, "type", "range");
    			attr_dev(input, "min", "1");
    			attr_dev(input, "max", "1440");
    			add_location(input, file, 199, 2, 5631);
    			attr_dev(div, "class", "overlay");
    			add_location(div, file, 197, 4, 5573);
    			add_location(main, file, 196, 0, 5561);
    		},
    ...
    function colorScaling(traffic) {
    	const scaleColor = d3.scaleLinear(["orange", "blue"]);
    	return scaleColor(traffic);
    }
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function update_station_markers() {
    		station_markers.transition().duration(1000).attr("r", function (d) {
    			...
    			let colorSetting = arrivals[d['station_id']] / (arrivals[d['station_id']] + departures[d['station_id']]);
    			return colorScaling(colorSetting);
    		});
    	}
